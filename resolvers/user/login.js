...
var LoginResolver = /** @class */ (function () {
    ...
    LoginResolver.prototype.login = function (username, password, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var userExist, user, token;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("dasdasd", username, password);
                    ...
                    case 1:
                        userExist = _a.sent();
                        if (!userExist) {
                            return [2 /*return*/, new Error("User not valid")];
                        }
                        user = userExist.userToJson();
                        token = user.refreshToken;
                        utils_1.sendRefreshToken(ctx.res, token);
